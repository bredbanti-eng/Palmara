...
const CHART_BASIS_NOTE = {
  ...
  moon: {
    en: "Birth time wasn't provided, so this chart is based on your Moon sign instead of the Ascendant.",
    hi: "जन्म समय उपलब्ध नहीं था, इसलिए यह कुंडली लग्न के बजाय आपकी चंद्र राशि पर आधारित है।",
  },
};
